...
public class ModalityController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<ModalityDTO> update(@PathVariable Long id, @Valid @RequestBody ModalityDTO dto) {
		return ResponseEntity.ok().body(modalityService.update(id, dto));
	}
